    ...
    <AnimatedSection className="py-20" id="gameplay" variant="slideLeft">
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <Badge className="mb-4 bg-tetris-green text-background">Classic Gameplay</Badge>
              ...
              <Card className="p-8 bg-card/50 backdrop-blur-sm border-tetris-green/20">
                <div className="grid grid-cols-10 gap-1 mb-6">
                  {Array.from({ length: 200 }).map((_, i) => {
                    ...
                    const colors = ["#00f5ff", "#ffff00", "#ff8800", "#aa00ff", "#00ff00", "#0088ff", "#ff0000"]
                    return (
                      <motion.div
                        key={i}
                      ...
                      >
                        <TetrisBlock
                          color={filled ? colors[Math.floor(Math.random() * colors.length)] : "#333"}
                          size={20}
                        />
                      </motion.div>
                    )
                ...
                <div className="text-center">
                  <p className="text-sm text-muted-foreground">Live Game Preview</p>
                </div>
              </Card>
            </ParallaxSection>
          </div>
